...
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_basic_limit_il;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_excess_limit_il;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_car_years;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_earned_premium;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_auto_outstanding;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_incurred_loss;
DROP FUNCTION IF EXISTS openidl_ep_9997.tmp_pa_incurred_count;
DROP TABLE IF EXISTS openidl_ep_9997.tmp_pa_coverage_ref;
DROP TABLE IF EXISTS openidl_ep_9997.tmp_pa_coverage;
...
CREATE OR replace FUNCTION  openidl_ep_9997.tmp_pa_car_years(IN start_date date,IN end_date date, IN pv_reporting_code VARCHAR)
...
CREATE OR REPLACE FUNCTION  openidl_ep_9997.tmp_pa_earned_premium(IN start_date date,IN end_date date, IN pv_reporting_code VARCHAR)
