function getReportingTable(companyId, startDate, endDate){
    sql =  `
...
AND CONCAT('01-',a.accounting_month,'-',a.accounting_year)::date >= '${startDate}'::DATE
AND CONCAT('01-',a.accounting_month,'-',a.accounting_year)::date <= '${endDate}'::DATE;
