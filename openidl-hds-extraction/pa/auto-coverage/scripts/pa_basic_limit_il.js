function getBasicLimitIl(companyId) {
	sql = `
CREATE OR replace FUNCTION openidl_ep_${companyId}.tmp_pa_basic_limit_il(IN start_date date,IN end_date date, IN pv_reporting_code varchar)
...
module.exports = getBasicLimitIl