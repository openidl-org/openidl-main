...
const stateCodes = require("./reference/farm-properties/stateCodes.json");
const areaIndicator = require("./reference/farm-properties/areaIndicator.json");
const transactionCodes = require("./reference/farm-properties/transactionCodes.json");
const annualStatementLineOfBusiness = require("./reference/farm-properties/annualStatementLineOfBusiness.json");
const programCodes = require("./reference/farm-properties/programCodes.json");
const deductibleType = require("./reference/farm-properties/deductibleType.json");
const deductibleAmount = require("./reference/farm-properties/deductibleAmount.json");
const windstormOrHailCoverageDeductibleAmount = require("./reference/farm-properties/windstormOrHailDeductible.json");
const classCodes = require("./reference/farm-properties/classCodes.json");
const constructionCodes = require("./reference/farm-properties/constructionCodes.json");
const coverageCodes = require("./reference/farm-properties/coverageCode.json")
const fireCodes = require("./reference/farm-properties/fireProtectionCodes.json");
const occupancyCodes = require("./reference/farm-properties/occupancyCodes.json");
const numberOfFamilies = require("./reference/farm-properties/numberOfFamilies.json");
const poolCode = require("./reference/farm-properties/poolCode.json");
const causeOfLoss = require("./reference/farm-properties/causeOfLoss.json");
const majorPerilCode = require("./reference/farm-properties/majorPeril.json")
const packageIdentification = require("./reference/farm-properties/packageIdentification.json")
const riskType = require("./reference/farm-properties/riskType.json")

// ***revisit this
//const exposure = require("./reference/farm-properties/exposure.json")
...
module.exports.converter = function (jsonRecord) {
  ...
  policy.LineOfInsurance = "Farm Properties";
  ...
  // Coverage Code
  coverage.CoverageCode = jsonRecord.coverageCode.trim()
