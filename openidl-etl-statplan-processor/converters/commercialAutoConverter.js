...
const stateCodes = require("./reference/commercial-auto/stateCodes.json");
const transactionCodes = require("./reference/commercial-auto/transactionCodes.json");
const programCodes = require("./reference/commercial-auto/programCodes.json");
const coverageCodes = require("./reference/commercial-auto/coverageCodes.json");
const sublineCodes = require("./reference/commercial-auto/sublineCodes.json");
const operatorAgeCodes = require("./reference/commercial-auto/operatorAgeCodes.json");
const sexAndMaritalStatusCodes = require("./reference/commercial-auto/sexAndMaritalStatusCodes.json");
const vehicleUseCodes = require("./reference/commercial-auto/vechicleUseCodes.json");
const vehiclePerformanceCodes = require("./reference/commercial-auto/vehiclePerformanceCodes.json");
...
const liabilityLimitCodes = require("./reference/commercial-auto/liabilityLimitCodes.json");
const deductibleCodes = require("./reference/commercial-auto/deductibleCodes.json");
const numberTypeCodes = require("./reference/commercial-auto/numberTypeCodes.json");
const vehicleClassCodes = require("./reference/commercial-auto/vehicleClassCodes.json");
const umUimCodes = require("./reference/commercial-auto/umUimCodes.json");
const terrorismIndicatorCodes = require("./reference/commercial-auto/terrorismIndicatorCodes.json");
const singleMultiCarCodes = require("./reference/commercial-auto/singleMultiCarCodes.json");
const packageCodes = require("./reference/commercial-auto/packageCodes.json");
const poolAffiliationCodes = require("./reference/commercial-auto/poolAffiliationCodes.json");
const ncProgramEnhancementCodes = require("./reference/commercial-auto/ncProgramEnhancementCodes.json");
const umuimStackingCodes = require("./reference/commercial-auto/umuimStackingCodes.json");
const passiveRestraintDiscountCodes = require("./reference/commercial-auto/passiveRestraintDiscountCodes.json");
const antiLockBrakesDiscountCodes = require("./reference/commercial-auto/antiLockBrakesDiscountCodes.json");
const antiTheftDeviceDiscountCodes = require("./reference/commercial-auto/antiTheftDeviceDiscountCodes.json");
const defensiveDriverDiscountCodes = require("./reference/commercial-auto/defensiveDriverDiscountCodes.json");
const pipLimitsDeductibleCodes = require("./reference/commercial-auto/pipLimitsDeductibleCodes.json");
const experienceRatingModificationFactorCodes = require("./reference/commercial-auto/experiencedRatingModificationFactorCodes.json");
const stateExceptionCodes = require("./reference/commercial-auto/stateExceptionCodes.json");
const causeOfLossCodes = require("./reference/commercial-auto/causeOfLossCodes.json");
const limitedCodingLossTransactionCodes = require("./reference/commercial-auto/limitedCodingLossTransactionCodes.json");
const { syncBuiltinESMExports } = require("module");
const commercialAutomobileClassification = require("./reference/commercial-auto/commercialAutomobileClassification.json");
const commercialAutomobileUse = require("./reference/commercial-auto/commercialAutomobileUse.json");
...
module.exports.converter = function (jsonRecord) {
  ...
  driver.CommercialAutoClassificationCode = jsonRecord.commercialAutomobileClassification.trim();
  // console.log(jsonRecord)
  // console.log(driver.CommercialAutoClassification)
  // console.log('AUTO CLASS CODE: ' + jsonRecord.commercialAutomobileClassification)
  driver.CommercialAutoClassification = jsonRecord.commercialAutomobileClassification.trim()
    ? commercialAutomobileClassification[jsonRecord.commercialAutomobileClassification].type
    : NOT_PROVIDED;
     //console.log(commercialAutomobileClassification[jsonRecord.commercialAutomobileClassification].name)
  driver.CommercialAutoClassificationDescription = jsonRecord.commercialAutomobileClassification.trim()
    ? commercialAutomobileClassification[jsonRecord.commercialAutomobileClassification].description
    : NOT_PROVIDED;

  driver.CommercialAutoUseCode = jsonRecord.commercialAutomobileUse.trim();
  driver.CommercialAutoUse = jsonRecord.commercialAutomobileUse.trim()
    ? commercialAutomobileUse[jsonRecord.commercialAutomobileUse].type
    : NOT_PROVIDED;
  driver.CommercialAutoUseDescription = jsonRecord.commercialAutomobileUse.trim()
    ? commercialAutomobileUse[jsonRecord.commercialAutomobileUse].description
    : NOT_PROVIDED;
