const premiumSchema = require("./schemas/general_liability/generalLiabilityStatPlan-policy.json");
const lossSchema = require("./schemas/general_liability/generalLiabilityStatPlan-claim.json");
// const converter = require("./converters/generalLiabilityConverter").converter;
...
function convertTextRecordToJsonUsingSchema(record, premiumSchema, lossSchema) {
  ...
  if (transactionCode == '1' || transactionCode == '8' || transactionCode == '9'){
    schema = premiumSchema
    premiumCount++
    console.log(`premium record ${premiumCount} found`)
