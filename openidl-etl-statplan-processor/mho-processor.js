const premiumSchema = require("./schemas/mobile_homeowners/mobileHomeownersStatPlan-policy.json");
const lossSchema = require("./schemas/mobile_homeowners/mobileHomeownersStatPlan-claim.json");
const converter = require("./converters/mobileHomeownerConverter").converter;
