...
carYears = `CREATE OR replace FUNCTION openidl_ep_${companyId}.auto_cy_reporting(IN start_date date,IN end_date date, IN pv_reporting_code VARCHAR)
...
BEGIN
    ...
    from (
        (SELECT 1 ggroup,            
            ...
            FROM   openidl_base_${companyId}.au_premium
