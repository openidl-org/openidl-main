function getMobileHomeownerClaim(companyId){
    sql = `CREATE TABLE openidl_base_${companyId}.mho_claim
    (
...
module.exports = getMobileHomeownerClaim
