    ...
    create table openidl_ep_9990.tmp_pre_au_coverage as
    ...
    from openidl_base_9990.au_premium a)
    union all
    ...
    from openidl_base_9990.au_loss b);
    ...
    select 
           case when a.coverage_code = '1' then '1'
                  ...
                  a.*
    from openidl_ep_9990.tmp_pre_au_coverage a;
...
|
    ...
    DROP TABLE openidl_ep_9990.tmp_au_coverage;|
    DROP TABLE openidl_ep_9990.tmp_au_coverage_ref;|
    DROP TABLE openidl_ep_9990.tmp_pre_au_coverage;|
