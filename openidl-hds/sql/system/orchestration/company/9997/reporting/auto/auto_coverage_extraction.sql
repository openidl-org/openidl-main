    ...
    from openidl_base_9997.au_policy a)
    union all
    ...
    from openidl_base_9997.au_claim b);
...
|
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_9997.auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
