    ...
    select * from openidl_base_9997.au_policy;   
    select * from openidl_base_9997.au_claim;

    select * from openidl_ep_9997.tmp_au_pc;
    select * from openidl_ep_9997.tmp_au_coverage;
    elect * from openidl_ep_9997.tmp_au_coverage_ref;
