    ...
    DROP TABLE  openidl_ep_9996.tmp_ho_pc;
    DROP TABLE  openidl_ep_9996.tmp_ho_reporting_ref;
    
    DROP FUNCTION IF EXISTS openidl_ep_9996.tmp_ho_earned_premium;
    DROP FUNCTION IF EXISTS openidl_ep_9996.tmp_ho_incurred_loss;
    DROP FUNCTION IF EXISTS openidl_ep_9996.tmp_ho_outstanding_loss;
    DROP FUNCTION IF EXISTS openidl_ep_9996.tmp_ho_paid_loss;
    DROP FUNCTION IF EXISTS openidl_ep_9996.tmp_ho_written_premium;
    
    |
    CREATE TABLE openidl_ep_9996.tmp_ho_pc as
    (SELECT reporting_category,
            ...
            months_covered
     FROM   openidl_base_9996.ho_policy a)
     UNION  ALL
    (SELECT reporting_category,
            reporting_form,
            policy_form,
     ...
     FROM   openidl_base_9996.ho_claim b);
    
    |
    CREATE TABLE openidl_ep_9996.tmp_ho_reporting_ref as
    SELECT reporting_category, reporting_form, policy_form
    FROM openidl_ep_9996.tmp_ho_pc
    GROUP BY reporting_category, reporting_form, policy_form;
    |
    CREATE OR replace FUNCTION openidl_ep_9996.tmp_ho_earned_premium(IN start_date date,IN end_date date, IN pv_policy_form VARCHAR)
    ...
    SELECT  reporting_category,
			policy_form,
     	    reporting_form,
        	openidl_ep_9996.Tmp_ho_written_premium(policy_form) written_premium,
        	openidl_ep_9996.Tmp_ho_paid_loss(policy_form) paid_loss,
        	round(openidl_ep_9996.Tmp_ho_paid_loss(policy_form) * 100 / openidl_ep_9996.Tmp_ho_written_premium(policy_form), 2) loss_ratio,
        	openidl_ep_9996.tmp_ho_earned_premium( '2002-08-15', '2003-08-15', policy_form) ep,
        	openidl_ep_9996.tmp_ho_incurred_loss(policy_form) incurred_loss,
        	round(openidl_ep_9996.tmp_ho_incurred_loss(policy_form) * 100 / openidl_ep_9996.tmp_ho_earned_premium( '2002-08-15', '2003-08-15', policy_form), 2) ep_loss_ratio
    FROM 	openidl_ep_9996.tmp_ho_reporting_ref order by reporting_category,reporting_form;
