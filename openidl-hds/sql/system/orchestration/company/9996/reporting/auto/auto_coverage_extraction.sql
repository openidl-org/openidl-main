    ...
    from openidl_base_9996.au_policy a)
    union all
    ...
    from openidl_base_9996.au_claim b);
...
|
    ...
    |
    CREATE OR replace FUNCTION openidl_ep_9996.auto_outstanding(IN start_date date,IN end_date date, IN pv_coverage_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_9996.auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
