    ...
    create table openidl_ep_1234.tmp_pre_au_coverage as
    ...
    from openidl_base_1234.au_premium a)
    union all
    ...
    from openidl_base_1234.au_loss b);
    ...
    select 
           case when a.coverage_code = '1' then '1'
                  ...
                  a.*
    from openidl_ep_1234.tmp_pre_au_coverage a;
...
|
    ...
    |
    CREATE OR replace FUNCTION openidl_ep_1234.auto_outstanding(IN start_date date,IN end_date date, IN pv_coverage_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_1234.auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
    ...
    DROP TABLE openidl_ep_1234.tmp_pre_au_coverage;|
