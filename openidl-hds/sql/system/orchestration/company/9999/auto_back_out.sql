    ...
    -- Tables
    DROP TABLE IF EXISTS openidl_base_9999.au_premium;
    DROP TABLE IF EXISTS openidl_base_9999.au_loss;

    DELETE FROM  openidl_base_9999.au_premium;
    DELETE FROM  TABLE openidl_base_9999.au_loss;
