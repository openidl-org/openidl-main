    ...
    DELETE FROM IF EXISTS openidl_base_9999.au_premium;
    DELETE FROM IF EXISTS TABLE openidl_base_9999.au_loss;

    -- Temp Tables
    DROP TABLE IF EXISTS openidl_ep_9999.tmp_pre_au_coverage;
    DROP TABLE IF EXISTS openidl_ep_9999.tmp_au_coverage;

    DELETE FROM IF EXISTS openidl_ep_9999.tmp_pre_au_coverage;
    DELETE FROM IF EXISTS openidl_ep_9999.tmp_au_coverage;
