    ...
    |
    create table openidl_ep_9999.tmp_au_pc as
    ...
    from openidl_base_9999.personal_auto_policy a)
    union all
    ...
    from openidl_base_9999.personal_auto_claim b);
    ...
    select 
           case when a.coverage_code = '1' then '1'
                  ...
                  a.*
    from openidl_ep_9999.tmp_au_pc a;
...
|
    ...
    |
    CREATE OR replace FUNCTION openidl_ep_9999.tmp_auto_outstanding(IN start_date date,IN end_date date, IN pv_coverage_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
        ...
        SELECT Sum(x.loss_amount) outstanding_loss
            FROM  (SELECT t2.coverage_code,
                ...
                FROM   (SELECT coverage_code,
                        ...
                        openidl_ep_9999.tmp_au_coverage t2
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_9999.tmp_auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
