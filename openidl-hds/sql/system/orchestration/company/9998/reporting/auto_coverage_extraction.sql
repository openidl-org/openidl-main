    ...
    from openidl_base_9998.au_loss b);
    
    |
    create table openidl_ep_9998.tmp_au_coverage as
    select 
           case when a.coverage_code = '1' then '1'
                  ...
                  a.*
    from openidl_ep_9998.tmp_pre_au_coverage a;
    
    |
    create table openidl_ep_9998.tmp_au_coverage_ref as
    ...
    |
CREATE OR replace FUNCTION openidl_ep_9998.tmp_car_years(IN start_date date,IN end_date date, IN pv_reporting_code VARCHAR)
...
|
    ...
    |
    CREATE OR replace FUNCTION openidl_ep_9998.auto_outstanding(IN start_date date,IN end_date date, IN pv_coverage_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_9998.auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
    
    |
    CREATE OR replace FUNCTION openidl_ep_9998.tmp_au_incurred_count(IN start_date date,IN end_date date, IN pv_reporting_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
    ...
    ,round(openidl_ep_9998.tmp_car_years('2000-01-01'::DATE, '2002-01-01'::DATE,a.reporting_code)) car_years
    ,round(openidl_ep_9998.tmp_au_incurred_count('2000-01-01'::DATE, '2002-01-01'::DATE,a.reporting_code)) incurred_count
    ,round(openidl_ep_9998.tmp_au_incurred_loss('2000-01-01'::DATE, '2002-01-01'::DATE,a.reporting_code)) incurred_loss
    from openidl_ep_9998.tmp_au_coverage_ref a; 
    
    |
 
    DROP TABLE openidl_ep_9998.tmp_au_coverage;|
    DROP TABLE openidl_ep_9998.tmp_au_coverage_ref;|
    ...
    DROP FUNCTION IF EXISTS openidl_ep_9998.tmp_auto_outstanding;|
