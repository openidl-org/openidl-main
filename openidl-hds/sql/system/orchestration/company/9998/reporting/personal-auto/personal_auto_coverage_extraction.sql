    ...
    DROP TABLE IF EXISTS openidl_ep_9998.tmp_au_coverage_ref;
    DROP TABLE IF EXISTS openidl_ep_9998.tmp_pre_au_coverage;
    DROP TABLE IF EXISTS openidl_ep_9998.tmp_au_pc;
    ...
    |
    create table openidl_ep_9998.tmp_au_pc as
    ...
    from openidl_base_9998.personal_auto_policy a)
    union all
    ...
    from openidl_base_9998.personal_auto_claim b);
    ...
    select 
           case when a.coverage_code = '1' then '1'
                  ...
                  a.*
    from openidl_ep_9998.tmp_au_pc a;
...
|
    ...
    |
    CREATE OR replace FUNCTION openidl_ep_9998.tmp_auto_outstanding(IN start_date date,IN end_date date, IN pv_coverage_code VARCHAR)
    returns      numeric AS $$DECLARE ep numeric;
    BEGIN
    ...
    BEGIN
        ...
        select sum(loss_amount) loss_amount
            ...
            and accident_date < end_date
            union
            (select openidl_ep_9998.tmp_auto_outstanding(start_date, end_date,'1') loss_amount))) a into ep; 
        RETURN ep;
    END$$ language plpgsql;
