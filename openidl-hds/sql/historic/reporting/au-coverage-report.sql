...
--au coverage report generateve with reporting code
select *, round(auto_ep_reporting('2000-01-01'::DATE, '2002-01-01'::DATE,a.reg_reporting_code)) earned_premium 
,round(auto_cy_reporting('2000-01-01'::DATE, '2002-01-01'::DATE,a.reg_reporting_code)) car_years
,round(auto_incurred_count_reporting('2000-01-01'::DATE, '2002-01-01'::DATE,a.reg_reporting_code)) incurred_count
,round(auto_incurred_loss_reporting('2000-01-01'::DATE, '2002-01-01'::DATE,a.reg_reporting_code)) incurred_loss
from openidl_base.au_reg_reporting_ref a; 
