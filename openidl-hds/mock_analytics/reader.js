    ...
    rows9998 = (n9999[0].result.result.rows)
...
for (index in rows9999){
    ...
    ep = nine['earned_premium'] + eight['earned_premium']
    cy = nine['car_years'] +  eight['car_years']
    il = nine['incurred_loss'] + eight['incurred_loss']
    ic = nine['incurred_count'] + eight['incurred_count']
...
for (line of report){
    out = `${line.ReportingName}, ${line.EarnedPremium}, ${line.CarYears}, ${line.IncurredLoss}, ${line.IncurredCount}`
    console.log(out)
    // console.table(line)
}