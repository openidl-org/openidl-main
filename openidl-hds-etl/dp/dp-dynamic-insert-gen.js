...
const records =
	require('../../../../con-data/Dwelling_Properties/dwellingProperties.json').records;
const credentials = {
...
// }
	...
	let query = 'INSERT INTO openidl_base_9999.dp_stat_stg (';
...
var file = fs.createWriteStream(
	'../../../../con-data/Dwelling_Properties/dp-insert.sql'
);
