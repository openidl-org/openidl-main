const config = require('../../openidl-hds-etl/config/config.json');
const fs = require('fs');
//const { Pool, Client } = require('pg');
const records =
	require('../../../../con-data/InlandMarine/inland_marine.json').records;
const credentials = {
...
// }
	...
	let query = 'INSERT INTO openidl_base_7777.im_stat_stg (';
...
var file = fs.createWriteStream(
	'../../../../con-data/InlandMarine/im-insert.sql'
);
