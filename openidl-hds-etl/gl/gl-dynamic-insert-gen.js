...
const records =
	require('../../../../con-data/General_Liability/generalLiability.json').records;
const credentials = {
...
function makeQuery(record) {
	...
	let query = 'INSERT INTO openidl_base_9999.gl_stat_stg (';
...
var file = fs.createWriteStream(
	'../../../../con-data/General_Liability/gl-insert.sql'
);
