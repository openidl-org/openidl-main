...
REP_DATE_MO VARCHAR(2) DEFAULT NULL,
REP_DATE_YR VARCHAR(2) DEFAULT NULL,
INCIDENT_LOC VARCHAR(2) DEFAULT NULL,
...
ENT_MO_CLM_MADE VARCHAR(2) DEFAULT NULL,
RATING_ID VARCHAR(1) DEFAULT NULL,
STAT_EXP_BASE VARCHAR(1) DEFAULT NULL,
TRANSACTION_ID VARCHAR(1) DEFAULT NULL,
RATING_BASIS VARCHAR(1) DEFAULT NULL,
ACT_OM_CLASS VARCHAR(1) DEFAULT NULL,
...
CLM_CLOSED_MO VARCHAR(2) DEFAULT NULL,
CLM_CLOSED_YR VARCHAR(2) DEFAULT NULL,
