...
const records =
	require('../../../../con-data/Commercial_Properties/commercialProperties.json').records;
const credentials = {
...
function makeQuery(record) {
	...
	let query = 'INSERT INTO openidl_base_9999.cp_stat_stg (';
...
var file = fs.createWriteStream(
	'../../../../con-data/Commercial_Properties/cp-insert.sql'
);
