...
let codeMap = require('../simple/privatePassengerDriversTrainingGoodStudentCodes.json');
let fileLines = []
let tableDDL = `
DO $$ 
BEGIN
...
var file = fs.createWriteStream('../../../tables/V0.0.1.20__pa_private_passenger_drivers_training_good_student_code.sql');
