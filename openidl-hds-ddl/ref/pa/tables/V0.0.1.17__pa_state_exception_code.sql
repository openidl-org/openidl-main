...
IF NOT EXISTS (SELECT * FROM pa_state_exception) THEN
    ...
    INSERT INTO pa_state_exception (id,name) VALUES (2, 'State Exception B');
    INSERT INTO pa_state_exception (id,name) VALUES (3, 'State Exception C');
END IF;
