...
IF NOT EXISTS (SELECT * FROM mho_escaped_liquid_fuel_and_lead_coverage_liability_code) THEN 
    INSERT INTO mho_escaped_liquid_fuel_and_lead_coverage_liability_code VALUES(1,'0','Without Property Remediation For Escaped Liquid Fuel / Limited lead Liability Coverage / or Does Not Apply','N/A');
    INSERT INTO mho_escaped_liquid_fuel_and_lead_coverage_liability_code VALUES(2,'1','Basic Limits ($50,000)','N/A');
