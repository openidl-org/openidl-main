...
--bt_hull_material_code
SELECT * FROM bt_hull_material_code;
DO $$ 
BEGIN
...
--bt_loss_settlement_indicator_code
SELECT * FROM bt_loss_settlement_indicator_code;
DO $$ 
BEGIN
...
--bt_multiple_single_owner_indicator_code
SELECT * FROM bt_multiple_single_owner_indicator_code;
DO $$ 
BEGIN
...
--bt_named_storm_deductible_code
SELECT * FROM bt_named_storm_deductible_code;
DO $$ 
BEGIN
...
--bt_navigational_territory_code
SELECT * FROM bt_navigational_territory_code;
DO $$ 
BEGIN
...
--bt_operator_experience_code
SELECT * FROM bt_operator_experience_code;
DO $$ 
BEGIN
...
--bt_transaction_code
SELECT * FROM bt_transaction_code;
DO $$ 
BEGIN
...
--bt_type_of_hull_code
SELECT * FROM bt_type_of_hull_code;
DO $$ 
BEGIN
...
--bt_type_of_loss_code
SELECT * FROM bt_type_of_loss_code;
DO $$ 
BEGIN
...
--bt_stat_gt2_tbl
SELECT * FROM bt_stat_gt2_tbl;CREATE TABLE IF NOT EXISTS bt_stat_stg (
ID SERIAL,
...
--bt_annual_statement_line_of_business_code
SELECT * FROM bt_annual_statement_line_of_business_code;
DO $$ 
BEGIN
...
--bt_cause_of_loss_code
SELECT * FROM bt_cause_of_loss_code;
DO $$ 
BEGIN
...
--bt_deductible_amount_code
SELECT * FROM bt_deductible_amount_code;
DO $$ 
BEGIN
...
--bt_deductible_type_code
SELECT * FROM bt_deductible_type_code;
DO $$ 
BEGIN
...
--bt_electronic_equipment_deductible_code
SELECT * FROM bt_electronic_equipment_deductible_code;
DO $$ 
BEGIN
...
--bt_stat_gt2_tbl
SELECT * FROM bt_stat_gt2_tbl;CREATE TABLE STATSGT2.AAIS_STAT_BT (
ID INT NOT NULL AUTO_INCREMENT,
TRANSMITTAL_ID INT NOT NULL,
CHANGE_COMMENTS VARCHAR(4000) DEFAULT NULL,
UPDATED_BY INT DEFAULT NULL,
