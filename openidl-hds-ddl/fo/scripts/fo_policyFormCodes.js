...
let codeMap = require('../codes/fo_policyFormCodes.json');
let fileLines = [];
let tableDDL = `
DO $$
BEGIN
...
for (let code of codes){
    ...
    line = `    INSERT INTO fo_policy_form_code VALUES(${index},'${code}','${type}','${category}','${reportingForm}','${reportingCategory}');`
    fileLines.push(line)
    index+=1
}
let end = `END IF;
...
var file = fs.createWriteStream('../tables/V0.0.1.6.22__fo_policy_form_code.sql');
