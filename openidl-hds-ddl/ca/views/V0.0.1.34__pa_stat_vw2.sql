  --what to do about accounting date?
  ...
  FROM   pa_stat_stg a
	join openidl_lob_code b
         ...
         left join pa_transaction_code e
                ON a.trans = e.code
                and a.accounting_date > e.effective_date 
                and a.accounting_date < e.expiration_date 
