...
for (let code of codes){
    ...
    let type = data['type'];
    line = `    INSERT INTO ho_deductible_amount_code VALUES(${index},'${code}','${description}','${type}');`
    fileLines.push(line)
    index+=1
}
let end = `END IF;
...
var file = fs.createWriteStream('../tables/V0.0.1.3.8__ho_deductible_amount_code.sql');
